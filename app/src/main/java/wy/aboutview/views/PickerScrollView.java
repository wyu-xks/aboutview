...
public class PickerScrollView extends View {
    ...
    private int mColorText = 0xff3f3f3f;
    ...
    private Bitmap weiXuan;
    private Bitmap yiXuan;
    ...
    private void init() {
        ...
        mLinePaint.setColor(0xffc4c4c4);
    ...
    private void drawData(Canvas canvas) {
        ...
        if (mDataList.size() > 0) {
            ...
            canvas.drawLine(0, y - 0.5f * size - dipToPx(5), mViewWidth, y - 0.5f * size - dipToPx(5), mLinePaint);
            canvas.drawLine(0, y + 0.5f * size + dipToPx(5), mViewWidth, y + 0.5f * size + dipToPx(5), mLinePaint);

//            canvas.drawBitmap(yiXuan, x - dipToPx(5) - yiXuan.getWidth() - 1.8f * size, y - yiXuan.getHeight() / 2, mLinePaint);
            // 绘制上方data
